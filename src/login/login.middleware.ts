...
export function loginRequestLogger(
  req: Request,
  res: Response,
  next: () => void
) {
...
export const ERR_LOGIN_ACCESS_DENIED = "login_access_denied"; //Spotify login access denied.
export const ERR_LOGIN_FINALIZE_DENIED = "login_finalize_denied"; //Failed to send custom sign in token.
export const ERR_LOGIN_OTHER_ERROR = "login_other_error"; //Failed to send custom sign in token.
